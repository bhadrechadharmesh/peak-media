...
const PROJECTS: Project[] = [
  {
    ...
    blurb:
      "A complete identity rebuild for a Series-B Mumbai fintech — from wordmark to motion system — that turned a forgotten challenger into a category reference.",
    gradient:
  ...
  },
  {
    id: "lumen",
    title: "Mira Beauty",
    client: "Mira Beauty Co.",
    category: "Web Design",
    metric: "+312%",
    metricLabel: "checkout conversion",
    blurb:
      "A sensory commerce experience built around Mira's hero serum — slower scrolls, warmer palettes, and a vernacular quiz-driven funnel that doubled AOV.",
    gradient:
  ...
  },
  {
    ...
    blurb:
      "A launch films trilogy + Reels velocity engine that put Urja's first model on every feed during the festive season — without spending a rupee on creator fees.",
    gradient:
  ...
  },
  {
    id: "northwind",
    title: "Sangam Coffee",
    client: "Sangam Roasters",
    category: "Content",
    metric: "5.2x",
    metricLabel: "ROAS on UGC",
    blurb:
      "A barista-led UGC engine producing 60 vernacular clips a month — tested across 14 audiences, trimmed weekly to the performers only.",
    gradient:
  ...
  },
  {
    ...
    blurb:
      "Rebuilt the paid funnel around DPDP-safe landing flows — creative testing matrix shrank CPL while doubling weekly lead volume across Tier-1 and Tier-2 cities.",
    gradient:
  ...
  },
  {
    id: "sterling",
    title: "Tantu Apparel",
    client: "Tantu Atelier",
    category: "Branding",
    metric: "72h",
    metricLabel: "to full sell-through",
    blurb:
      "A capsule launch identity and drop-campaign system — waitlist, packaging, and a 60-second film that sold out the run before the festive weekend ended.",
    gradient:
  ...
  },
  {
    id: "quartz",
    title: "Vastu Studio",
    client: "Vastu Architects",
    category: "Web Design",
    metric: "−61%",
    metricLabel: "bounce rate",
    blurb:
      "A spatial portfolio that treats each project as a room — WebGL-light, scroll-choreographed, and tuned for prospective Bengaluru clients who skim in 9 seconds.",
    gradient:
  ...
  },
  {
    ...
    blurb:
      "A creator-led social engine where trainers double as talent — weekly format series, vernacular reels, and a community that converts itself.",
    gradient:
