...
export const CERTIFICATES: Record<string, Certificate> = {
  "PM-INT-2026-0142": {
    ...
    mentor: "Sanket",
    grade: "A+",
    skills: ["Node.js", "Express.js", "MongoDB", "REST APIs", "Git", "Redis", "Docker", "PostgreSQL"],
    status: "Completed",
    location: "Mumbai",
  ...
  "PM-INT-2025-0187": {
    id: "PM-INT-2025-0187",
    internName: "Karthik Reddy",
    role: "Brand & Creative Intern",
    department: "Creative",
    ...
    mentor: "Priya Menon",
    grade: "A",
    skills: ["Brand Strategy", "Figma", "Copywriting", "Visual Identity"],
    status: "Completed",
    location: "Bengaluru",
  ...
  "PM-INT-2024-0331": {
    id: "PM-INT-2024-0331",
    internName: "Sneha Iyer",
    role: "SEO & Content Intern",
    department: "Growth",
    startDate: "September 2, 2024",
    endDate: "December 6, 2024",
    duration: "4 months",
    issueDate: "December 12, 2024",
    mentor: "Arjun Nair",
    grade: "A+",
    skills: ["Technical SEO", "Content Strategy", "Ahrefs", "Semrush"],
    status: "Completed",
    location: "Mumbai",
  ...
  "PM-INT-2025-0209": {
    ...
    grade: "A",
    skills: ["Reels Production", "Community Management", "Analytics", "Creator Outreach"],
    status: "Completed",
    location: "Delhi",
  ...
  "PM-INT-2025-0238": {
    ...
    mentor: "Vikram Shah",
    grade: "A+",
    skills: ["Figma", "Webflow", "Framer", "UX Research"],
    status: "Completed",
    location: "Bengaluru",
